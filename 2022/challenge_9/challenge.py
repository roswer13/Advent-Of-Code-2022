...
You step carefully; as you do, the ropes stretch and twist. You decide to distract yourself by modeling rope physics; maybe
you can even figure out where not to step.
...
with open("challenge_9/input.txt") as text_file:
    blocks_lines = text_file.read().strip().split("\n")
    blocks = [block.split(" ") for block in blocks_lines]
...
print(f"Postion to part 1: {part_1()}")
print(f"Postion to part 2: {part_2()}")
